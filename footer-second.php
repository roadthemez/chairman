		...
		<div class="footer-middle">
			<div class="container">
				<div class="row">	
					...
					<?php }
					if( isset($chairman_opt['footer_menu3']) && $chairman_opt['footer_menu3']!='' ) {
						$menu3_object = wp_get_nav_menu_object( $chairman_opt['footer_menu3'] );
						$menu3_args = array(
							'menu_class'      => 'nav_menu',
							'menu'         => $chairman_opt['footer_menu3'],
						); ?>
