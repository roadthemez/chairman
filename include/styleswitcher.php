			...
			<form name="styleswitcher" action="<?php echo esc_url( home_url( '/' ) ); ?>" method="post">
				...
				<div class="home-layouts">
					...
					<div class="layout-scroll scrollbar-outer">
							...
							<ul>
								<li><a href="<?php echo get_site_url(); ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/screenshots/home1.png" alt="" /><span>Home 1</span></a></li>
								<li><a href="<?php echo get_site_url().'/home-shop-2/'; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/screenshots/home2.png" alt="" /><span>Home 2</span></a></li>
								<li><a href="<?php echo get_site_url().'/home-shop-3/'; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/screenshots/home3.png" alt="" /><span>Home 3</span></a></li>
								<li><a href="<?php echo get_site_url().'/home-shop-4/'; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/screenshots/home4.png" alt="" /><span>Home 4</span></a></li>
								<!--<li><a href="<?php echo get_site_url().'/home-shop-5/'; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/screenshots/home5.png" alt="" /><span>Home 5</span></a></li>
								<li><a href="<?php echo get_site_url().'/home-shop-6/'; ?>"><img src="<?php echo get_template_directory_uri(); ?>/images/screenshots/home6.png" alt="" /><span>Home 6</span></a></li>
