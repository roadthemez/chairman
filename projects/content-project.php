...
global $post, $projects_loop, $chairman_opt, $chairman_projectrows, $chairman_projectsfound;
...
$projects_loop['columns'] = $chairman_opt['portfolio_columns'];
...
<?php if ( ( 0 == $projects_loop['loop'] % 2 || $chairman_projectsfound == $projects_loop['loop'] ) && ( $projects_loop['columns'] == 2 ) ) { /* for odd case: $chairman_projectsfound == $projects_loop['loop'] */
	if($chairman_projectrows!=1) {
		echo '</div>';
	}
} ?>