		...
		<div class="post-info"> 
			...
			<?php else : ?>
				<div class="entry-summary">
					<?php the_excerpt(); ?>
					<a class="readmore button" href="<?php the_permalink(); ?>"><?php if(isset($chairman_opt['readmore_text']) && $chairman_opt['readmore_text']!=''){ echo esc_html($chairman_opt['readmore_text']); } else { echo esc_html_e('Read more', 'chairman');}  ?></a>
