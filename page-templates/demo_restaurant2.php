...
$_SESSION["preset"] = 12;
/**
 * Template Name: Demo Restaurant 2
 *
...
<style type="text/css">
	body {
		background: #010405 url(../images/restaurant2_bg.jpg) 50% 0 !important;
		float: left;
		width: 100%;
	}
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper box-layout">
		<div class="page-wrapper">
			<div class="header-container restaurant2">  
				<div class="container">
					<div class="header">
											...
											<div class="global-row">
												<div class="global-cell">
													<?php if( isset($chairman_opt['logo_main']['url']) ){ ?>
														<div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri() . '/images/restaurant2_logo.png'; ?>" alt="<?php bloginfo( 'name' ); ?>" /></a></div>
													<?php
													} else { ?>
