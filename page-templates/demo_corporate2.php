...
$_SESSION["preset"] = 4;
/**
 * Template Name: Demo Corporate 2
 *
...
<body <?php body_class('home'); ?>>
	...
	<div class="wrapper <?php if($chairman_opt['page_layout']=='box'){echo 'box-layout';}?>">
		<div class="page-wrapper">
			<div class="header-container corporate2"> 
				<div class="header">
										...
										<div class="global-row">
											<div class="global-cell">
												<?php if( isset($chairman_opt['logo_main']['url']) ){ ?>
													<div class="logo"><a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="<?php echo get_template_directory_uri() . '/images/logo_corporate1.png'; ?>" alt="<?php bloginfo( 'name' ); ?>" /></a></div>
												<?php
												} else { ?>
